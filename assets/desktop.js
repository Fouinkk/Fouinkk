...
document.querySelector("textarea").value = "Hey Hustlers!\n\nAvant toute chose, nous tenons à vous mentionner qu'il faut être conscient qu'on est encore en temps de covid et par le fait même limité par des réglementations. Nous avons tout pris en compte afin de vous offrir le plus sick party tout maximisant nos chances de ne pas obtenir une amende de 2000$.\n\nCeci étant dit, le Party commence ici\n\nThématique: Début des années 2000 (Hip-hop,R&B, Dance Dance, etc)\nDate: 30 octobre 2021\n\nConsignes:\n\n- Afin d'obtenir les informations concernant le party (lieu, heure, coût et autres), vous devrez aller sur MSN sporadiquement d'ici le 30 oct.\n\n- Toutes les icônes sur le bureau vous donnent un accès à du contenu exclusif et elles seront mises à jours sporadiquement.\n\nEnjoy\n\nPS. Le Desktop a été créer par Faisal Akhtar.\n\n"
